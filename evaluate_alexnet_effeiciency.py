...
if __name__ == "__main__":
    ...
    for frac in FRAC_LIST:
        ...
        np.savetxt("performance/Alexnet_structured_%.2f_efficiency.txt"%frac, inference_time_matrix)


    np.savetxt("performance/Alexnet_structured_num_params.txt", num_params_list)
